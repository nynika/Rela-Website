...
const NewPatientPaymentDetails = () => {
    ...
    const handleNextStep = async (e) => {
        ...
        if (!PatientID || !PatientName || !AppointmentId || !ChargeRate || !Email || !MobileNo || !ProcessingId) {
            toast.error("All patient details are required to proceed with the payment.");
            return;
        }
        ...
        try {
            ...
            toast.error("Error during the payment process.");
        } finally {
            setLoading(false);
        }
    };
...
export default NewPatientPaymentDetails;
